    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="name" type="text" class="block w-full mt-1" wire:model="createApiTokenForm.name"
                    autofocus />
                        ...
                        @foreach ($this->user->tokens->sortBy('name') as $token)
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center ms-2">
                                    ...
                                    @if (Laravel\Jetstream\Jetstream::hasPermissions())
                                        <button class="text-sm text-gray-400 underline cursor-pointer ms-6"
                                            wire:click="manageApiTokenPermissions('{{ $token->id }}')">
                                            {{ __('Permissions') }}
                                        </button>
                                    @endif

                                    <button class="text-sm text-red-500 cursor-pointer ms-6"
    ...
    <x-dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                class="w-full px-4 py-2 mt-4 font-mono text-sm text-gray-500 break-all bg-gray-100 rounded" autofocus
